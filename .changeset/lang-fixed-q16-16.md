...
fraction, range -32768.0 through 32767.99998 at 1/65536 precision. It was
Q8.8: ±127.99.
...
syscalls needs updating. Because existing syscall numbers have a new operand
shape, the `.gx` format major is `0x0200`.
