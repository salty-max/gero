import { processModule, machineCodeAsHex } from '../src/assembler'

describe('instructions', () => {
  it('should parse MOV_LIT_REG correctly', () => {
    const input = 'mov $0042, r1'
    const code = processModule(input, 0)

    expect(machineCodeAsHex(code.machineCode)).toBe('0x10 0x00 0x42 0x02')
  })
  ...
  it('should parse MOV_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x11 0x03 0x02')
  })
  ...
  it('should parse MOV_REG_MEM correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x12 0x03 0x00 0x50')
  })
  ...
  it('should parse MOV_MEM_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x13 0x00 0x50 0x02')
  })
  ...
  it('should parse MOV_LIT_MEM correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x14 0x00 0x42 0x00 0x50')
  })
  ...
  it('should parse MOV_REG_PTR_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x15 0x02 0x03')
  })
  ...
  it('should parse MOV_LIT_OFF_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x17 0x00 0x02 0x02 0x03')
  })
  ...
  it('should parse MOV8_LIT_MEM correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x70 0x02 0x12 0x34')
  })

  it('should parse MOV8_MEM_REG correctly', () => {
    const input = 'mov8 &1234, r1'
    const code = processModule(input, 0)
    console.log(machineCodeAsHex(code.machineCode))

    expect(machineCodeAsHex(code.machineCode)).toBe('0x71 0x12 0x34 0x02')
  })
  ...
  it('should parse MOVL_REG_MEM correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x72 0x02 0x12 0x34')
  })
  ...
  it('should parse MOVH_REG_MEM correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x73 0x02 0x12 0x34')
  })
  ...
  it('should parse MOV8_REG_PTR_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x74 0x02 0x03')
  })
  ...
  it('should parse ADD_LIT_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x1B 0x00 0x02 0x02')
  })
  ...
  it('should parse sub_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x1F 0x02 0x03')
  })
  ...
  it('should parse MUL_LIT_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x20 0x00 0x02 0x02')
  })
  ...
  it('should parse MUL_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x21 0x02 0x03')
  })
  ...
  it('should parse INC_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x35 0x02')
  })
  ...
  it('should parse DEC_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x36 0x02')
  })
  ...
  it('should parse LSF_REG_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x26 0x02 0x00 0x02')
  })
  ...
  it('should parse LSF_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x27 0x02 0x03')
  })
  ...
  it('should parse RSF_REG_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x2A 0x02 0x00 0x02')
  })
  ...
  it('should parse RSF_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x2B 0x02 0x03')
  })
  ...
  it('should parse AND_REG_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x2E 0x02 0x00 0x02')
  })
  ...
  it('should parse AND_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x2F 0x02 0x03')
  })
  ...
  it('should parse OR_REG_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x30 0x02 0x00 0x02')
  })
  ...
  it('should parse OR_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x31 0x02 0x03')
  })
  ...
  it('should parse XOR_REG_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x32 0x02 0x00 0x02')
  })
  ...
  it('should parse XOR_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x33 0x02 0x03')
  })
  ...
  it('should parse NOT correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x34 0x02')
  })
  ...
  it('should parse JEQ_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x3E 0x02 0x00 0x60')
  })
  ...
  it('should parse JNE_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x40 0x02 0x00 0x60')
  })
  ...
  it('should parse JNE_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x41 0x00 0x02 0x00 0x60')
  })
  ...
  it('should parse JLT_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x42 0x02 0x00 0x60')
  })
  ...
  it('should parse JLT_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x43 0x00 0x02 0x00 0x60')
  })
  ...
  it('should parse JGT_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x44 0x02 0x00 0x60')
  })
  ...
  it('should parse JGT_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x45 0x00 0x02 0x00 0x60')
  })
  ...
  it('should parse JLE_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x46 0x02 0x00 0x60')
  })
  ...
  it('should parse JLE_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x47 0x00 0x02 0x00 0x60')
  })
  ...
  it('should parse JGE_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x48 0x02 0x00 0x60')
  })
  ...
  it('should parse PSH_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x18 0x00 0x02')
  })
  ...
  it('should parse PSH_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x19 0x02')
  })
  ...
  it('should parse POP correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x1A 0x01')
  })
  ...
  it('should parse CAL_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x5F 0x02')
  })
})
...
describe('data', () => {
  it('should handle data8 values as literals', () => {
    ...
    expect(machineCodeAsHex(code.machineCode)).toBe('0x01 0x02 0x03 0x04')
  })
