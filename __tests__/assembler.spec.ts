import { parseProgram, machineCodeAsHex } from '../src/assembler'
...
describe('instructions', () => {
  it('should parse MOV_LIT_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('10 00 42 02')
  })
  ...
  it('should parse MOV_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('11 03 02')
  })
  ...
  it('should parse MOV_REG_MEM correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('12 03 00 50')
  })
  ...
  it('should parse MOV_MEM_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('13 00 50 02')
  })
  ...
  it('should parse MOV_LIT_MEM correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('14 00 42 00 50')
  })
  ...
  it('should parse MOV_REG_PTR_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('15 02 03')
  })
  ...
  it('should parse MOV_LIT_OFF_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('16 00 02 02 03')
  })
  ...
  it('should parse ADD_LIT_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('1B 00 02 02')
  })
  ...
  it('should parse ADD_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('1C 02 03')
  })
  ...
  it('should parse sub_LIT_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('1D 00 02 02')
  })
  ...
  it('should parse sub_REG_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('1E 02 00 02')
  })
  ...
  it('should parse sub_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('1F 02 03')
  })
  ...
  it('should parse MUL_LIT_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('20 00 02 02')
  })
  ...
  it('should parse MUL_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('21 02 03')
  })
  ...
  it('should parse INC_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('35 02')
  })
  ...
  it('should parse DEC_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('36 02')
  })
  ...
  it('should parse LSF_REG_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('26 02 00 02')
  })
  ...
  it('should parse LSF_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('27 02 03')
  })
  ...
  it('should parse RSF_REG_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('2A 02 00 02')
  })
  ...
  it('should parse RSF_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('2B 02 03')
  })
  ...
  it('should parse AND_REG_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('2E 02 00 02')
  })
  ...
  it('should parse AND_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('2F 02 03')
  })
  ...
  it('should parse OR_REG_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('30 02 00 02')
  })
  ...
  it('should parse OR_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('31 02 03')
  })
  ...
  it('should parse XOR_REG_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('32 02 00 02')
  })
  ...
  it('should parse XOR_REG_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('33 02 03')
  })
  ...
  it('should parse NOT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('34 02')
  })
  ...
  it('should parse JEQ_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('3E 02 00 60')
  })
  ...
  it('should parse JEQ_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('3F 00 02 00 60')
  })
  ...
  it('should parse JNE_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('40 02 00 60')
  })
  ...
  it('should parse JNE_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('41 00 02 00 60')
  })
  ...
  it('should parse JLT_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('42 02 00 60')
  })
  ...
  it('should parse JLT_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('43 00 02 00 60')
  })
  ...
  it('should parse JGT_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('44 02 00 60')
  })
  ...
  it('should parse JGT_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('45 00 02 00 60')
  })
  ...
  it('should parse JLE_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('46 02 00 60')
  })
  ...
  it('should parse JLE_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('47 00 02 00 60')
  })
  ...
  it('should parse JGE_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('48 02 00 60')
  })
  ...
  it('should parse JGE_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('49 00 02 00 60')
  })
  ...
  it('should parse PSH_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('17 00 02')
  })
  ...
  it('should parse PSH_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('18 02')
  })
  ...
  it('should parse POP correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('1A 01')
  })
  ...
  it('should parse CAL_LIT correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('5E 00 60')
  })
  ...
  it('should parse CAL_REG correctly', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('5F 02')
  })
})
...
describe('labels', () => {
  ...
  it('should handle labels as adresses', () => {
    ...
    expect(machineCodeAsHex(code)).toBe('10 00 42 02 3E 02 00 04')
  })
})
